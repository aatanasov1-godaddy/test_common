...
PY_FILES = f'--py-files {CODE_PATH}/customer_venture/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"active_flag": '
                 '"is_active", '
                 '"venture_composition_desc": '
                 '"description", '
                 '"venture_create_utc_ts": '
                 '"create_ts", '
                 '"billing_resource_id": '
                 '"resource_id", '
                 '"ecommerce_flag": '
                 ...
                 '"dormant_flag": '
                 '"is_dormant", '
                 '"brick_mortar_business_flag": '
                 '"is_brick_and_mortar_business", '
                 '"service_area_business_flag": '
                 '"is_service_area_business", '
                 '"professional_services_flag": '
                 '"is_professional_services", '
                 '"dataprovider_business_tier_code": '
                 '"dp_business_tier", '
                 '"address_or_phone_present_flag": '
                 '"is_address_or_phone_on_website", '
                 '"active_website_flag": '
                 '"is_active_website", '
                 '"gd_social_universe_code": '
                 '"gd_social_universe", '
                 '"lead_type_code": '
                 '"lead_type", '
                 '"venture_segment_name": '
                 '"venture_segment", '
...
with DAG(
        ...
        max_active_runs=1,
        catchup=False,
        schedule_interval=None if Variable.get('mwaa_env') == 'dev-private' else '00 15 * * *',
    ...
    location = f'{s3_datalake}/customer_venture/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'

    data_lake_success = SnapshotSuccessNotificationOperator(
        task_id='data_lake_success',
        db_name='marketing_egress_mart',
        table_name='customer_venture',
