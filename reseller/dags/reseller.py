...
PY_FILES = f'--py-files {CODE_PATH}/reseller/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"program_id": '
                 '"program_id", '
                 '"private_label_id": '
                 ...
                 '"active_flag": '
                 '"is_active", '
                 '"forward_to_private_label_id": '
                 '"forward_to_private_label_id", '
                 '"my_product_url": '
                 '"my_product_url", '
                 '"contact_preferences_url": '
                 '"contact_preferences_url", '
...
with DAG(
    ...
    location = f'{s3_datalake}/reseller/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'
