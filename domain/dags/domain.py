...
PY_FILES = f'--py-files {CODE_PATH}/domain/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"create_utc_ts": '
                 '"create_ts", '
                 '"marketing_category": '
                 ...
                 '"mail_provider_name": '
                 '"mail_provider", '
                 '"ssl_certificate_flag": '
                 '"is_ssl_certificate", '
                 '"ssl_secured_flag": '
                 '"is_ssl_secured", '
                 '"last_activation_utc_ts": '
                 '"latest_activation_ts", '
                 '"local_traffic_30d_session_count": '
                 '"local_traffic_30_day_count", '
                 '"ssl_end_utc_ts": '
                 '"ssl_end_ts", '
                 '"ecommerce_certainty_score": '
                 '"ecommerce_certainty", '
                 '"brick_and_mortar_flag": '
                 '"is_brick_and_mortar", '
                 '"hosted_flag": '
                 '"is_hosted", '
                 '"mail_flag": '
                 ...
                 '"published_site_flag": '
                 '"is_published_site", '
                 '"social_media_type_array": '
                 '"social_media_types", '
                 '"social_media_widget_array": '
                 '"social_media_widgets", '
                 '"domain_status_name": '
                 '"domain_status", '
                 '"domain_valuation_usd_amt": '
                 '"domain_valuation", '
                 '"brazil_key_systems_flag": '
                 '"is_br_key_systems", '
...
with DAG(
        ...
        max_active_runs=1,
        catchup=False,
        schedule_interval=None if Variable.get('mwaa_env') == 'dev-private' else '0 13 * * *',
    ...
    location = f'{s3_datalake}/domain/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'
