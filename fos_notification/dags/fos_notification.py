...
PY_FILES = f'--py-files {CODE_PATH}/fos_notification/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"domain_expiration_multiple_flag": '
                 '"is_domain_expiration_multiple", '
                 '"domain_expiration_single_flag": '
                 '"is_domain_expiration_single", '
                 '"domain_manual_renewal_multiple_flag": '
                 '"is_domain_manual_renewal_multiple", '
                 '"domain_manual_renewal_single": '
                 '"is_domain_manual_renewal_single", '
                 '"dop_cancelation_alert_flag": '
                 '"is_dop_cancellation_alert", '
                 '"dop_suspension_alert_flag": '
                 '"is_dop_suspension_alert", '
                 '"expired_credit_card_alert_flag": '
                 '"is_expired_credit_card_alert", '
                 '"expired_payment_tied_to_renewal_flag": '
                 '"is_expired_payment_tied_to_renewal", '
                 '"expiring_email_address_flag": '
                 '"is_expiring_email_address", '
                 '"failed_billing_flag": '
                 '"is_failed_billing", '
                 '"missing_payment_tied_to_auto_renewal_flag": '
                 '"is_missing_payment_tiedto_auto_renewal", '
                 '"sms_sign_up_flag": '
                 '"is_sms_sign_up", '
                 '"update_payment_method_90_day_flag": '
                 '"is_update_payment_method90day", '
                 '"update_payment_method_expired_flag": '
                 '"is_update_payment_method_expired", '
                 '"update_payment_method_expires_today_flag": '
                 '"is_update_payment_method_expires_today", '
...
with DAG(
        ...
        max_active_runs=1,
        catchup=False,
        schedule_interval=None if Variable.get('mwaa_env') == 'dev-private' else '30 8 * * *',
    ...
    location = f'{s3_datalake}/fos_notification/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'

    data_lake_success = SnapshotSuccessNotificationOperator(
        task_id='data_lake_success',
        db_name='marketing_egress_mart',
        table_name='customer_fos_notification',
