...
### General Information
- Dataset Name         : domain_aftermarket_premium_suggestion
...
DAG_ID = 'domain_aftermarket_premium_suggestion'
...
PY_FILES = f'--py-files {CODE_PATH}/domain_aftermarket_premium_suggestion/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"pick_rank_num": '
                 '"pick_best", '
                 '"suggested_domain_price_usd_amt": '
                 '"suggested_domain_price", '
                 '"owned_domain_expiration_utc_ts": '
                 '"owned_domain_expiration_ts", '
...
with DAG(
    ...
    ingest_data_stg = RunEMRStepOperator(
        ...
        step_cmd=(
                  ...
                  '-d mdm_local '
                  '-t domain_aftermarket_premium_suggestion_history '
                  f'-e {ENV}'
                 ),
        trigger_rule='none_failed_min_one_success'
    )
    ...
    ingest_data_main = RunEMRStepOperator(
        ...
        step_cmd=(
                  ...
                  '-d mdm_local '
                  '-t domain_aftermarket_premium_suggestion '
                  f'-e {ENV}'
                 ),
        trigger_rule='none_failed_min_one_success'
    )
    ...
    location = f'{s3_datalake}/domain_aftermarket_premium_suggestion/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'

    data_lake_success = SnapshotSuccessNotificationOperator(
        task_id='data_lake_success',
        db_name='marketing_egress_mart',
        table_name='domain_aftermarket_premium_suggestion',
