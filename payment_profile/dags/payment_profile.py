...
PY_FILES = f'--py-files {CODE_PATH}/payment_profile/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"customer_id": '
                 '"CustomerID", '
                 '"payment_profile_id": '
                 ...
                 '"payment_sub_type": '
                 '"PaymentSubType", '
                 '"expiration_month_num": '
                 '"ExpirationMonth", '
                 '"expiration_year_num": '
                 '"ExpirationYear", '
                 '"tied_to_active_paid_product_flag": '
                 '"IsTiedToActivePaidProduct", '
                 '"tied_to_active_product_flag": '
                 '"IsTiedToActiveProduct", '
                 '"expired_flag": '
                 '"IsExpired", '
                 '"method_blacklist_flag": '
                 '"IsMethodBlacklist", '
...
with DAG(
    ...
    location = f'{s3_datalake}/payment_profile/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'

    data_lake_success = SnapshotSuccessNotificationOperator(
        task_id='data_lake_success',
        db_name='marketing_egress_mart',
        table_name='customer_payment_profile',
