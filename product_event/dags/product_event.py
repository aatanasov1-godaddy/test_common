...
PY_FILES = f'--py-files {CODE_PATH}/product_event/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"order_utc_ts": '
                 '"order_ts", '
                 '"free_trial_order_utc_ts": '
                 '"free_trial_order_ts", '
                 '"cancel_utc_ts": '
                 '"cancel_ts", '
                 '"first_mile_stone_utc_ts": '
                 '"first_milestone_ts", '
                 '"set_up_complete_utc_ts": '
                 '"setup_complete_ts", '
                 '"answered_category_and_business_activation_flag": '
                 '"is_answered_category_and_business_activation", '
                 '"activated_flag": '
                 '"is_activated", '
                 '"ssl_issued_flag": '
                 '"is_ssl_issued", '
                 '"published_flag": '
                 '"is_published", '
                 '"added_first_product_to_site_utc_ts": '
                 '"added_first_product_to_site_ts", '
...
with DAG(
        ...
        max_active_runs=1,
        catchup=False,
        schedule_interval=None if Variable.get('mwaa_env') == 'dev-private' else '20 9 * * *',
    ...
    location = f'{s3_datalake}/product_event/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'
