...
### General Information
- Dataset Name         : domain_registry_premium_suggestion
...
DAG_ID = 'domain_registry_premium_suggestion'
...
PY_FILES = f'--py-files {CODE_PATH}/domain_registry_premium_suggestion/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"pick_rank_num": '
                 '"pick_best", '
...
with DAG(
    ...
    ingest_data_stg = RunEMRStepOperator(
        ...
        step_cmd=(
                  ...
                  '-d mdm_local '
                  '-t domain_registry_premium_suggestion_history '
                  f'-e {ENV}'
                 ),
        trigger_rule='none_failed_min_one_success'
    )
    ...
    ingest_data_main = RunEMRStepOperator(
        ...
        step_cmd=(
                  ...
                  '-d mdm_local '
                  '-t domain_registry_premium_suggestion '
                  f'-e {ENV}'
                 ),
        trigger_rule='none_failed_min_one_success'
    )
    ...
    location = f'{s3_datalake}/domain_registry_premium_suggestion/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'

    data_lake_success = SnapshotSuccessNotificationOperator(
        task_id='data_lake_success',
        db_name='marketing_egress_mart',
        table_name='domain_registry_premium_suggestion',
