...
PY_FILES = f'--py-files {CODE_PATH}/product/spark/sql/*,{CODE_PATH}/utils/*'
CUSTOM_RENAME = (
                 '{"billing_attempt_cnt": '
                 '"billing_attempt_count", '
                 '"billing_cancel_utc_ts": '
                 '"cancelled_ts", '
                 '"billing_create_utc_ts": '
                 '"billing_create_ts", '
                 '"dpp_solution_set_name": '
                 '"dpp_solution_set", '
                 '"expiration_utc_ts": '
                 '"expiration_ts", '
                 '"active_flag": '
                 ...
                 '"is_primary_product", '
                 '"next_domain_auto_renewal_utc_ts": '
                 '"next_domain_auto_renewal_ts", '
                 '"original_base_order_utc_ts": '
                 '"original_base_order_ts", '
                 '"version7_website_flag": '
                 '"is_version7_website", '
                 '"workspace_email_mailbox_cnt": '
                 '"workspace_email_mailbox_count", '
                 '"pick_best_id": '
                 '"pickbest", '
                 '"billing_utc_ts": '
                 '"billing_ts", '
...
with DAG(
        ...
        max_active_runs=1,
        catchup=False,
        schedule_interval=None if Variable.get('mwaa_env') == 'dev-private' else '30 3 * * *',
    ...
    location = f'{s3_datalake}/product/partition_utc_date={utcnow.strftime("%Y-%m-%d")}/'
